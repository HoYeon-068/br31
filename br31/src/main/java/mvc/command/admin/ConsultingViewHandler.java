...
public class ConsultingViewHandler implements CommandHandler{
	...
	public String process(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ConsultingDTO dto = dao.selectAdminView(consultingId);
            request.setAttribute("dto", dto);

            request.setAttribute("contentPage", "/WEB-INF/views/admin/consulting/view.jsp");
