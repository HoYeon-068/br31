      ...
      <header class="page-header">
        <div class="page-header__container">
          <div class="page-header__content">
            <h2 class="page-header__title">아이스크림 맛 제안 요청</h2>
          </div>

          <div class="page-header__content">
            <p class="page-header__text">배스킨라빈스에서 출시되었으면 하는 맛을 제안해주세요</p>
          </div>
        </div>
      </header>
              ...
              <fieldset class="plaza-form__container">
                ...
                <div class="plaza-form__content">
                  ...
                  <div class="form-area">
                    <div>
                      <ul>
                        <li><span>1.</span> 개인정보의 수집ㆍ이용 목적 : 아이스크림 맛 제안 아이디어 채택 시 제안자 식별 및 연락</li>
                        <li><span>2.</span> 수집하려는 개인정보의 항목 :  ①이름 ②연락처 ③이메일 주소</li>
                        <li><span>3.</span> 개인정보의 보유 및 이용 기간 : 수집•이용 동의일로부터 12개월 또는 동의 철회 시 까지</li>
                      </ul>

                      <p>
                        위의 개인정보 수집•이용에 대한 동의를 거부할 권리가 있습니다.
                        그러나 동의를 거부할 경우 아이스크림 맛 제안 아이디어 채택에 제한을 받을 수 있습니다.
                      </p>
                    </div>
                  </div>
                  ...
                  <div class="form-area">
                    <div>
                      <ul>
                        ...
                        <li><span>6.</span> 회사는 제안자에게 소정의 보상금을 지급하거나 별도의 계약을 체결하여 저작재산권을 양수 받아 제안자의 아이디어를 제품화, 지적재산권 확보, 수정 및 보완, 기타 방법으로 자유롭게 활용할 수 있습니다.</li>
                      </ul>
                ...
                <div class="plaza-form__content">
                  <div class="plaza-form-field">
                    ...
                    <div class="plaza-form-field__container">
                      <dl class="plaza-form-field__content plaza-form-field__content--middle">
                        <div class="plaza-form-field__item">
                          <dt class="plaza-form-field__name form__name">작성자 공개</dt>
                          <dd class="plaza-form-field__area">
                            ...
                            <ul class="plaza-form-list">
                              <li class="plaza-form-list__item">* 작성자 비공개 시 작성하신 글에 작성자 이름이 노출되지 않습니다</li>
                              <li class="plaza-form-list__item">* 입력된 연락처를 우선으로 필요한 경우 담당자가 고객님께 개별 연락 드릴 예정입니다.</li>
                            </ul>
                          </dd>
                        </div>
                      </dl>
                        ...
                        <div class="plaza-form-field__item">
                          ...
                          <dd class="plaza-form-field__area">
                            <div class="plaza-form-textarea form-content">
                              <textarea name="content" class="plaza-form-textarea__textarea"></textarea>
