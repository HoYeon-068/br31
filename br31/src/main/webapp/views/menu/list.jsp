...
<script type="text/javascript" src="${pageContext.request.contextPath}/${pageContext.request.contextPath}/wcs.naver.net/wcslog.js"></script>
...
<script>
    ...
    '${pageContext.request.contextPath}/${pageContext.request.contextPath}/connect.facebook.net/en_US/fbevents.js');
...
<!-- kakao Pixel Code -->
<script type="text/javascript" charset="UTF-8" src="${pageContext.request.contextPath}/${pageContext.request.contextPath}/t1.daumcdn.net/kas/static/kp.js"></script>
<script type="text/javascript">
...
<script src="${pageContext.request.contextPath}/${pageContext.request.contextPath}/karrot-pixel.business.daangn.com/0.1/karrot-pixel.umd.js"></script>
<script>
...
<script>
    ...
    },s.version='1.1',s.queue=[],u=t.createElement(n),u.async=!0,u.src='${pageContext.request.contextPath}/${pageContext.request.contextPath}/static.ads-twitter.com/uwt.js',
...
'${pageContext.request.contextPath}/${pageContext.request.contextPath}/www.googletagmanager.com/gtm5445.html?id='+i+dl;f.parentNode.insertBefore(j,f);
